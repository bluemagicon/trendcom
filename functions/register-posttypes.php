...
function baw_register_my_cpts() {
	...
	$labels = [
		"name" => __( "Stellenangebote", "baw" ),
		"singular_name" => __( "Stellenangebot", "baw" ),
		"all_items" => __( "Stellenangebote", "baw" ),
	];

	$args = [
		"label" => __( "Stellenangebote", "baw" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
		...
		"map_meta_cap" => true,
		"hierarchical" => false,
		"rewrite" => [ "slug" => "stellenangebot", "with_front" => true ],
		"query_var" => true,
		"menu_position" => 22,
